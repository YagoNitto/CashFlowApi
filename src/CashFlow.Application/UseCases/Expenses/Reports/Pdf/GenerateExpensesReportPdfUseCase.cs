...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateTime month)
    {
        ...
        CreateTotalSpentSectionAndName(page, month, totalExpenses);
        ...
        foreach (var expense in expenses)
        {
            ...
            row.Cells[0].AddParagraph(expense.Date.ToString("dd/MM/yyyy dddd"));
            ...
            if (string.IsNullOrWhiteSpace(expense.Description) == false)
            {
                ...
                descriptionRow.Cells[0].Shading.Color = ColorHelper.GreenLight;
    ...
    private void CreateTotalSpentSectionAndName(Section page, DateTime month, decimal totalExpenses)
    {
        var paragraph = page.AddParagraph();
        
        paragraph.Format.SpaceAfter = 40;
        
        paragraph.AddFormattedText("Olá, John Doe", new Font{ Name = FontHelper.RALEWAY_BLACK, Size = 20 });
        ...
        paragraph.AddFormattedText(
            $"{totalExpenses} {CurrencySymbol}", new Font{ Name = FontHelper.WORKSANS_BLACK, Size = 40 });
    }
